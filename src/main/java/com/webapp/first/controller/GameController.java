...
import com.webapp.first.service.GameService;
import com.webapp.first.service.TwitchException;
...
public class GameController {
    ...
    public void getGame(@RequestParam(value = "game_name", required = false) String gameName,
        ...
        // get url ?game_name=LOL 赋给gameName
//        *** fetch data from url @PathVariable
